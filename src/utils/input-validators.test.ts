...
describe('Input Validators', () => {
  describe('validateColumn', () => {
    ...
    it('should accept valid alignment', () => {
      ALIGNMENTS.forEach((alignment) => {
        expect(() => validateColumn({ name: 'test', alignment })).not.toThrow();
      });
    });
    ...
    it('should accept valid color', () => {
      COLORS.forEach((color) => {
        expect(() => validateColumn({ name: 'test', color })).not.toThrow();
      });
    });

    it('should throw for negative maxLen', () => {
      expect(() => validateColumn({ name: 'test', maxLen: -5 })).toThrow(
        TableInputError
      );
      expect(() => validateColumn({ name: 'test', maxLen: -5 })).toThrow(
        /maxLen must be a non-negative number/
      );
    });
    ...
    it('should throw for negative minLen', () => {
      expect(() => validateColumn({ name: 'test', minLen: -5 })).toThrow(
        TableInputError
      );
      expect(() => validateColumn({ name: 'test', minLen: -5 })).toThrow(
        /minLen must be a non-negative number/
      );
    });
  ...
  describe('validateColumns', () => {
    it('should throw for non-array input', () => {
      expect(() => validateColumns('not-an-array' as any)).toThrow(
        TableInputError
      );
      expect(() => validateColumns('not-an-array' as any)).toThrow(
    ...
    it('should throw for array with invalid column', () => {
      expect(() => validateColumns(['valid', ''])).toThrow(TableInputError);
    });

    it('should throw for duplicate column names', () => {
      expect(() => validateColumns(['col1', 'col2', 'col1'])).toThrow(
        TableInputError
      );
      expect(() => validateColumns(['col1', 'col2', 'col1'])).toThrow(
      ...
      expect(() =>
        validateColumns([{ name: 'col1' }, { name: 'col2' }, { name: 'col1' }])
      ).toThrow(TableInputError);
    });

    it('should accept valid columns array', () => {
      expect(() => validateColumns(['col1', 'col2', 'col3'])).not.toThrow();

      expect(() =>
        validateColumns([{ name: 'col1' }, { name: 'col2' }, { name: 'col3' }])
      ).not.toThrow();
  ...
  describe('validateRowData', () => {
    it('should throw for null or undefined input', () => {
      expect(() => validateRowData(null as any)).toThrow(TableInputError);
      expect(() => validateRowData(undefined as any)).toThrow(TableInputError);
      expect(() => validateRowData(null as any)).toThrow(
        /Row data must be a non-null object/
      );
    });

    it('should throw for non-object input', () => {
      expect(() => validateRowData('not-an-object' as any)).toThrow(
        TableInputError
      );
      expect(() => validateRowData(123 as any)).toThrow(TableInputError);
    });

    it('should accept valid row data', () => {
      expect(() => validateRowData({})).not.toThrow();
  ...
  describe('validateRows', () => {
    it('should throw for non-array input', () => {
      expect(() => validateRows('not-an-array' as any)).toThrow(
        TableInputError
      );
      expect(() => validateRows('not-an-array' as any)).toThrow(
    ...
    it('should throw if any row is invalid', () => {
      expect(() =>
        validateRows([{ col1: 'value1' }, null as any, { col1: 'value2' }])
      ).toThrow(TableInputError);
    });
  ...
  describe('validateColor', () => {
    it('should throw for invalid color', () => {
      expect(() => validateColor('invalid_color')).toThrow(TableInputError);
      expect(() => validateColor('invalid_color')).toThrow(/Invalid color/);
    });
