...
function runAllTests() {
    ...
    assert(typesRender.includes('10.99'), 'Table should contain float value "10.99"');
    assert(typesRender.includes('true'), 'Table should contain boolean value "true"');
    assert(typesRender.includes('false'), 'Table should contain boolean value "false"');
    ...
    assert(comprehensiveRender.includes('PRODUCT NAME'), 'Custom column title not found');
    assert(comprehensiveRender.includes('IN STOCK'), 'Custom column title not found');
