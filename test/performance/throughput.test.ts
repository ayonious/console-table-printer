...
describe('Throughput Performance Tests', () => {
  ...
  const createMediumDataset = () => Array.from({ length: 100 }, (_, i) => ({
    id: i + 1,
    name: `User ${i + 1}`,
  ...
  const createLargeDataset = () => Array.from({ length: 1000 }, (_, i) => ({
    id: i + 1,
    name: `User ${i + 1}`,
    email: `user${i + 1}@example.com`,
    score: Math.floor(Math.random() * 1000),
  ...
  const measureThroughput = (operation: () => void, durationMs: number = 1000): number => {
  ...
  describe('Table Creation Throughput', () => {
    it('should create tables at high throughput', () => {
      ...
      expect(throughput).toBeGreaterThan(THROUGHPUT_LIMITS.tableCreationsPerSecond);
      console.log(`Table creation throughput: ${throughput.toFixed(2)} ops/sec`);
    });
    ...
    it('should create configured tables at reasonable throughput', () => {
      ...
      expect(throughput).toBeGreaterThan(THROUGHPUT_LIMITS.tableCreationsPerSecond * 0.1); // 10% of basic creation
      console.log(`Configured table creation throughput: ${throughput.toFixed(2)} ops/sec`);
    });
  });
  ...
  describe('Row Addition Throughput', () => {
    it('should add single rows at high throughput', () => {
      ...
      expect(throughput).toBeGreaterThan(THROUGHPUT_LIMITS.rowAdditionsPerSecond);
      console.log(`Single row addition throughput: ${throughput.toFixed(2)} ops/sec`);
    });
    ...
    it('should add rows with options at reasonable throughput', () => {
      ...
      expect(throughput).toBeGreaterThan(THROUGHPUT_LIMITS.rowAdditionsPerSecond * 0.5); // 50% of basic addition
      console.log(`Row addition with options throughput: ${throughput.toFixed(2)} ops/sec`);
    });
    ...
    it('should add bulk rows at reasonable throughput', () => {
      ...
      expect(throughput).toBeGreaterThan(THROUGHPUT_LIMITS.bulkOperationsPerSecond);
      console.log(`Bulk row addition throughput: ${throughput.toFixed(2)} ops/sec`);
    });
  });
  ...
  describe('Render Operation Throughput', () => {
    it('should render small tables at high throughput', () => {
      ...
      expect(throughput).toBeGreaterThan(THROUGHPUT_LIMITS.renderOperationsPerSecond);
      console.log(`Small table render throughput: ${throughput.toFixed(2)} ops/sec`);
    });
    ...
    it('should render medium tables at reasonable throughput', () => {
      ...
      expect(throughput).toBeGreaterThan(THROUGHPUT_LIMITS.renderOperationsPerSecond * 0.1); // 10% of small table
      console.log(`Medium table render throughput: ${throughput.toFixed(2)} ops/sec`);
    });
    ...
    it('should render large tables at acceptable throughput', () => {
      ...
      expect(throughput).toBeGreaterThan(THROUGHPUT_LIMITS.renderOperationsPerSecond * 0.01); // 1% of small table
      console.log(`Large table render throughput: ${throughput.toFixed(2)} ops/sec`);
    });
  });
  ...
  describe('Print Operation Throughput', () => {
    it('should print small tables at reasonable throughput', () => {
      ...
      expect(throughput).toBeGreaterThan(THROUGHPUT_LIMITS.printOperationsPerSecond);
      console.log(`Small table print throughput: ${throughput.toFixed(2)} ops/sec`);
    });
    ...
    it('should print medium tables at acceptable throughput', () => {
      ...
      expect(throughput).toBeGreaterThan(THROUGHPUT_LIMITS.printOperationsPerSecond * 0.1); // 10% of small table
      console.log(`Medium table print throughput: ${throughput.toFixed(2)} ops/sec`);
    });
  });
  ...
  describe('printTable Function Throughput', () => {
    it('should handle printTable at reasonable throughput', () => {
      ...
      expect(throughput).toBeGreaterThan(THROUGHPUT_LIMITS.printOperationsPerSecond);
      console.log(`printTable function throughput: ${throughput.toFixed(2)} ops/sec`);
    });
    ...
    it('should handle printTable with medium data at acceptable throughput', () => {
      ...
      expect(throughput).toBeGreaterThan(THROUGHPUT_LIMITS.printOperationsPerSecond * 0.1);
      console.log(`printTable with medium data throughput: ${throughput.toFixed(2)} ops/sec`);
    });
  });
  ...
  describe('Complex Operations Throughput', () => {
    it('should handle table creation and population at reasonable throughput', () => {
      ...
      expect(throughput).toBeGreaterThan(THROUGHPUT_LIMITS.bulkOperationsPerSecond);
      console.log(`Full table workflow throughput: ${throughput.toFixed(2)} ops/sec`);
    });
    ...
    it('should handle configured tables with sorting at acceptable throughput', () => {
      ...
      expect(throughput).toBeGreaterThan(THROUGHPUT_LIMITS.bulkOperationsPerSecond * 0.1);
      console.log(`Configured table with sorting throughput: ${throughput.toFixed(2)} ops/sec`);
    });
    ...
    it('should handle tables with filtering at acceptable throughput', () => {
      ...
      expect(throughput).toBeGreaterThan(THROUGHPUT_LIMITS.bulkOperationsPerSecond * 0.1);
      console.log(`Table with filtering throughput: ${throughput.toFixed(2)} ops/sec`);
    });
  });
  ...
  describe('Stress Testing Throughput', () => {
    it('should maintain throughput under sustained load', () => {
      ...
      const avgThroughput = durations.reduce((a, b) => a + b, 0) / durations.length;
      const variance = durations.reduce((acc, val) => acc + Math.pow(val - avgThroughput, 2), 0) / durations.length;
      ...
      expect(avgThroughput).toBeGreaterThan(THROUGHPUT_LIMITS.printOperationsPerSecond);
      
      console.log(`Sustained load average throughput: ${avgThroughput.toFixed(2)} ops/sec, Std Dev: ${stdDev.toFixed(2)}`);
    });
    ...
    it('should handle rapid successive operations', () => {
      ...
      expect(throughput).toBeGreaterThan(THROUGHPUT_LIMITS.bulkOperationsPerSecond);
      console.log(`Rapid successive operations throughput: ${throughput.toFixed(2)} ops/sec`);
    });
  });
  ...
  describe('Edge Cases Throughput', () => {
    it('should handle empty datasets at high throughput', () => {
      ...
      expect(throughput).toBeGreaterThan(THROUGHPUT_LIMITS.printOperationsPerSecond * 2); // Should be very fast
    ...
    it('should handle single row datasets at high throughput', () => {
      ...
      expect(throughput).toBeGreaterThan(THROUGHPUT_LIMITS.printOperationsPerSecond);
      console.log(`Single row dataset throughput: ${throughput.toFixed(2)} ops/sec`);
    });
    ...
    it('should handle wide datasets at reasonable throughput', () => {
      ...
      expect(throughput).toBeGreaterThan(THROUGHPUT_LIMITS.printOperationsPerSecond * 0.5);
